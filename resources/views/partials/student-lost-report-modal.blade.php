...
<div id="studentLostReportReviewModal" class="srm-overlay" role="dialog" aria-modal="true" aria-labelledby="studentLostReportReviewTitle"
  ...
  <div class="srm-modal" onclick="event.stopPropagation()" style="max-width:min(560px,96vw);">
    ...
    <div class="srm-body">
      ...
      <div class="srm-form-row srm-review-consent">
        <label class="srm-review-consent-label">
          <input type="checkbox" id="studentLostReportReviewConsent" class="srm-review-consent-check">
          <span class="srm-review-consent-text">I hereby authorize that the above details are accurate and correct.</span>
        </label>
      </div>
