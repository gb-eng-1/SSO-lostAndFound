    ...
    public function show(Request $request): JsonResponse
    {
        ...
        if (str_starts_with($id, 'REF-')) {
            ...
            $data = [
                ...
                'color'              => $item->color,
                'brand'              => $item->brand,
                'date_lost'          => $item->date_lost ? $item->date_lost->format('Y-m-d') : null,
                'status'             => $item->status,
        ...
        $data = [
            ...
            'date_found' => $item->date_encoded ? $item->date_encoded->format('Y-m-d') : null,
            'date_encoded' => $item->date_encoded ? $item->date_encoded->format('M d, Y') : '—',
            'status' => $item->status,
            'item_description' => $item->item_description,
            'image_data' => $item->image_data,
            'parsed' => [
